...
const nft_collection_ranking_router_1 = __importDefault(require("./nft-collection-ranking.router"));
...
router.use('/nftCollection', nft_collection_ranking_router_1.default);
