...
const nft_collection_controller_1 = __importDefault(require("../controllers/nft-collection.controller"));
const router = express_1.default.Router();
router.post('/createRanking/:contractAddress', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const controller = new nft_collection_controller_1.default();
